...
public abstract class InstallerSupport implements Installer {
    private static final Logger logger = LogManager.getLogger(InstallerSupport.class);

    protected Map<String, String> getLatestVersions(JSONObject manifest) {
    ...
    protected String getServerJarURL(JSONObject manifest, String version) {
    ...
    protected void downloadWithProgress(String fileURL, String saveFile) {
        try {
    ...
    protected void printProgress(int downloaded, int totalSize) {
    ...
    protected void animateLoading(int steps) {
        String[] frames = {"⠁", "⠂", "⠄", "⡀", "⢀", "⠠", "⠐", "⠈"};
